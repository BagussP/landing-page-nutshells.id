  ...
  return (
    <div>
      ...
      <div className="px-10 flex flex-col gap-5">
        ...
        <p>
          Nutshell&apos;s.id built the Info Sabilussalam app as a Free app. This
          SERVICE is provided by Nutshell&apos;s.id at no cost and is intended
          for use as is.
        </p>
        <p>
        ...
        <p>
          ...
          Terms and Conditions, which are accessible at Info Sabilussalam unless
        ...
        <p>
          ...
          but not limited to Image, Camera, Location, File, User Profile,
          Permission, Ads. The information that I request will be retained on
        ...
        <p>
          ...
          not hesitate to contact me at nutshells.id@gmail.com.
        </p>
        <p>
